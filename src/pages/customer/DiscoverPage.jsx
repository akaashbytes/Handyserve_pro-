...
export default function DiscoverPage() {
  ...
  // Separated into two effects to avoid re-registering the interval on every tick.
  useEffect(() => {
  ...
  // Auto-accept after ~5 s (requestTime drops from 180 → 175) and handle timeout
  useEffect(() => {
    if (!isRequesting) return;
    if (requestTime === 175) {
  ...
  }, [requestTime, isRequesting, activeBookingId, updateBookingStatus]);
