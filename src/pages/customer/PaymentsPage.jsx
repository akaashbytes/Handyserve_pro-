...
export default function PaymentsPage() {
  ...
  const applyPromo = () => {
    ...
    else { setPromoError('Invalid code. Try: FIRST50, CLEAN200, SUMMER10'); setDiscount(null); }
  };
  ...
  const confirmPayment = (e) => {
    ...
    setTimeout(() => {
      ...
      updateBookingStatus(id, 'Completed'); // Transition from Pending Payment to Completed
